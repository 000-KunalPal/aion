...
// biome-ignore lint/complexity/noExcessiveCognitiveComplexity: <only testing>
function RouteComponent() {
	...
	return (
		<>
			<style
				// biome-ignore lint/security/noDangerouslySetInnerHtml: <only testing>
								...
								<div className="space-y-6">
									<div>
										<button
											...
											type="button"
										>
											<div className="absolute inset-0 bg-linear-to-r from-red-500/10 to-orange-500/10 opacity-0 transition-opacity group-hover:opacity-100" />
									...
									<div>
										<button
											...
											type="button"
										>
											<div className="absolute inset-0 bg-linear-to-r from-blue-500/10 to-purple-500/10 opacity-0 transition-opacity group-hover:opacity-100" />
											<div className="relative">
												<div className="mb-2 flex items-center">
													<span className="font-medium">
